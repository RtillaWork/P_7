...
export default class Photos extends Component {
        ...
        axiosInstance.get(`/?method=${FLIKR_API.METHOD}&api_key=${FLIKR_API.KEY}&${FLIKR_API.ARGUMENTS}`)
            .then(res => {
                this.setState({
                    ...
                    totalPerPage: res.data.photos.perpage,
                    isLoaded: true
                });
    ...
    render() {
        ...
        return (
            <div className=" ">
                <button className='w-100 my-3 bg-dark btn btn-lg rounded text-center'
                        onClick={this.retrieveNextPhotos}>More #bikerace #BoulderBikeTour photos
                </button>
                <div className="mx-auto text-center">
                    {photos}
                </div>
                <button className='w-100 my-3 bg-dark btn btn-lg rounded' onClick={this.retrieveNextPhotos}>More
                    #bikerace #BoulderBikeTour photos
                </button>
            </div>
        );
    }
