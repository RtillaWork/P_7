...
handleSubmit (e) {
  e.preventDefault();
    const data = JSON.stringify({ slogan_submission: {
  ...
  .catch( err => {
    ...
    render() { 
      let message = ''; 
      let submitButtonDiv = (<input type="submit" className="btn btn-warning btn-lg mx-auto" value="Submit my slogan"/>);
      ...
      if (this.state.submitStatus === 'SUBMIT_SUCCESS') {
        ...
        submitButtonDiv = (<p className="font-weight-bold text-white h2 bg-info p-2 text-center">Your submission has been received successfully!</p>);
      }
            ...
            {message}
             <form onSubmit={this.handleSubmit }>
              <div className="form-group">
                  <label htmlFor="firstName" className="font-weight-bold text-white p-2 h2 bg-secondary ">First name</label>
             ...
             <div className="form-group">
                  <label htmlFor="lastName" className="font-weight-bold  text-white p-2 h2 bg-secondary  ">Last name</label>
        ...
        <div className="form-group">
                <label htmlFor="email" className="font-weight-bold text-white p-2 h2 bg-secondary ">Email address</label>
        ...
        <div className="form-group">
                    <label htmlFor="sloganText" className="font-weight-bold text-white p-2 h2 bg-secondary  ">Your Slogan</label>
